...
/**
 * A classe <b>Arvore</b> Ã© a classe para armazenar a estrutura de dado árvore AVL.
 *
...
public class Arvore implements Serializable {
    ...
    /**
     * Método que designa um novo No raiz da árvore.
     ...
     * @param aComparar Ná a ser comparado
    ...
    /**
     *Método que verifica o balanceamento de um nó da Ã¡rvore.
 ...
 public void remover(Comparable palavra) {
    ...
    //código baseado na implementação de Rodrigo Vilar, usuário do GitHub: rodrigoVilar
